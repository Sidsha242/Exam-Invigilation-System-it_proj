...
import logo from '../assets/nav_manipal.svg'
              ...
              <div className="hidden md:block md:ml-96">
                <div className="ml-10 flex items-baseline space-x-4">
                  ...
                  {isloggedIn ? (
                    <Link
                      to="/logout"
                      className="bg-orange-400 hover:bg-[#FA9884]  py-2 px-4 rounded"
                    >
                      Log Out
                    </Link>
                  ) : (
